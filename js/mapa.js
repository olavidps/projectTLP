//    google map start
    (function($) {
        ...
        function init() {
            var mapOptions = {
                center: new google.maps.LatLng(-8.113766, -79.037202),
                zoom: 15,
                zoomControl: false,
                zoomControlOptions: {
...
//                ]
            ...
            var mapElement = document.getElementById('mapaCaja');
            ...
            var contentString = 
                '<div id="content">'+
                    '<div class="mapInfoWindowRowInner">'+
                        '<h5>Project Prolog</h5>'+
                        '<p>Av Juan Pablo II<br> FFCCMM 3er Piso</p>'+
                    '</div>'+
                '</div>';
